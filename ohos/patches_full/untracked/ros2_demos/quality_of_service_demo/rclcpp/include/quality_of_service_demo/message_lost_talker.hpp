...
#ifndef QUALITY_OF_SERVICE_DEMO__MESSAGE_LOST_TALKER_HPP_
#define QUALITY_OF_SERVICE_DEMO__MESSAGE_LOST_TALKER_HPP_
...
public:
    ...
    message_size_(8u * 1024u * 1024u)
  {
    ...
    timer_ = this->create_wall_timer(std::chrono::seconds(3), publish_message);
  }
...
#endif  // QUALITY_OF_SERVICE_DEMO__MESSAGE_LOST_TALKER_HPP_
