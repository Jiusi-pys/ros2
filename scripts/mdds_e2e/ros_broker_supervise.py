...
if role=='ros' and (root/'graph_case').is_file():
    ...
    if case not in ('graph:service_client_ownership','graph:endpoint_metadata','graph:duplicate_node_names'):raise ValueError('unsupported graph case')
