...
BUILD_BASE="${ROS2_OHOS_COLCON_BUILD_BASE:-${ROOT_DIR}/build/ohos-colcon-rk3588s}"
INSTALL_BASE="${ROS2_OHOS_COLCON_INSTALL_BASE:-${ROOT_DIR}/install/ohos-colcon-rk3588s}"
...
# generated by colcon_rk3588s.sh for OHOS target Python
...
echo "colcon RK3588S build complete:"
